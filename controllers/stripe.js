...
exports.createConnectAccount = async (req, res) => {
    ...
    // 3. create account link baseed on account id (for frontend to cmplete onboarding)
...
exports.stripeSession = async (req, res) => {
    ...
    // 2 find hotel based on hotel id from db
    const item = await Hotel.findById(hotelId).populate('postedBy').exec();
    
    // 3 20% charge as applicatino fee
    ...
    // 7 add this session object o user in the db
